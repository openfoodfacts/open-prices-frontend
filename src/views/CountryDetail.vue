  ...
  <v-row>
    <v-col>
      ...
      <template v-if="!loading">
        <LoadedCountChip :loadedCount="countryLocationList.length" :totalCount="countryLocationTotal" />
...
export default {
  ...
  methods: {
    ...
    getCountryLocations() {
      if ((this.countryLocationTotal != null) && (this.countryLocationList.length >= this.countryLocationTotal)) return
      this.loading = true
