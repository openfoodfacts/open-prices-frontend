...
const routes = [
  ...
  { path: '/create-product', alias: '/experiments/create-off-product', name: 'create-product', component: () => import('./views/CreateOffProduct.vue'), meta: { title: 'CreateProduct', icon: 'mdi-package-variant-plus', requiresAuth: true, breadcrumbs: [{title: 'CreateProduct', disabled: true }] }},
