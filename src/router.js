...
const routes = [
  ...
  { path: '/proofs/add/multiple', name: 'proof-add-multiple', component: () => import('./views/PriceTagProofAddMultiple.vue'), meta: { title: 'AddProofs', icon: 'mdi-image-plus', requiresAuth: true, breadcrumbs: [{title: 'AddProofs', disabled: true }] }},
