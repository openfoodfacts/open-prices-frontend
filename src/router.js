...
const routes = [
  ...
  { path: '/experiments/challenge', name: 'challenge', component: () => import('./views/CurrentChallenge.vue'), meta: { title: 'Current Challenge', icon: 'mdi-medal-outline',  breadcrumbs: [{title: 'Experiments', disabled: false, to: '/experiments' }, {title: 'Challenge Page', disabled: true }] }},
  // Why this redirect?
