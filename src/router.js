...
const routes = [
  ...
  { path: '/challenge', name: 'current-challenge', component: () => import('./views/ChallengeDetail.vue'), meta: { title: 'Challenge', icon: 'mdi-trophy-variant', drawerMenu: false,  breadcrumbs: [{title: 'Challenge', disabled: true }] }},
  ...
  { path: '/challenges/:id', name: 'challenge-detail', component: () => import('./views/ChallengeDetail.vue'), meta: { title: 'Challenge', icon: 'mdi-trophy-variant',  breadcrumbs: [{title: 'CommunityChallenge', disabled: true }] }},
