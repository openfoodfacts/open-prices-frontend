...
const routes = [
  ...
  { path: '/prices', name: 'prices', component: () => import('./views/PriceList.vue'), meta: { title: 'LatestPrices', icon: constants.PRICE_ICON, breadcrumbs: [{title: 'LatestPrices', disabled: true }] }},
  { path: '/proofs/:id', name: 'proof-detail', component: () => import('./views/ProofDetail.vue'), meta: { title: 'Proof detail', requiresAuth: true }},
  { path: '/proofs', name: 'proofs', component: () => import('./views/ProofList.vue'), meta: { title: 'LatestProofs', icon: constants.PROOF_ICON, breadcrumbs: [{title: 'LatestProofs', disabled: true }] }},
  { path: '/products', name: 'products', component: () => import('./views/ProductList.vue'), meta: { title: 'TopProducts', icon: constants.PRODUCT_ICON, breadcrumbs: [{title: 'TopProducts', disabled: true }] }},
  { path: '/products/:id', name: 'product-detail', component: () => import('./views/ProductDetail.vue'), meta: { title: 'Product detail' }},
  { path: '/locations', name: 'locations', component: () => import('./views/LocationList.vue'), meta: { title: 'TopLocations', icon: constants.LOCATION_ICON, breadcrumbs: [{title: 'TopLocations', disabled: true }] }},
  ...
  { path: '/countries', name: 'countries', component: () => import('./views/CountryList.vue'), meta: { title: 'Countries', icon: constants.COUNTRY_ICON, breadcrumbs: [{title: 'Countries', disabled: true }] }},
  ...
  { path: '/challenge', name: 'current-challenge', component: () => import('./views/ChallengeDetail.vue'), meta: { title: 'Challenge', icon: constants.CHALLENGE_ICON, drawerMenu: false,  breadcrumbs: [{title: 'Challenges', disabled: false, to: '/challenges' }, {title: 'CommunityChallenge', disabled: true }] }},
  { path: '/challenges', name: 'challenges', component: () => import('./views/ChallengeList.vue'), meta: { title: 'Challenges', icon: constants.CHALLENGE_ICON, drawerMenu: true, breadcrumbs: [{title: 'Challenges', disabled: true }] }},
  { path: '/challenges/:id', name: 'challenge-detail', component: () => import('./views/ChallengeDetail.vue'), meta: { title: 'Challenge', icon: constants.CHALLENGE_ICON,  breadcrumbs: [{title: 'Challenges', disabled: false, to: '/challenges' }, {title: ':id', disabled: true }] }},
  ...
  { path: '/badges', name: 'badges', component: () => import('./views/BadgeList.vue'), meta: { title: 'Badges', icon: constants.BADGE_ICON, drawerMenu: true, breadcrumbs: [{title: 'Badges', disabled: true }] }},
  { path: '/badges/:id', name: 'badge-detail', component: () => import('./views/BadgeDetail.vue'), meta: { title: 'Badge detail', breadcrumbs: [{title: 'Badges', disabled: false, to: '/badges' }, {title: ':id', disabled: true }] }},
  { path: '/experiments', name: 'experiments', component: () => import('./views/Experiments.vue'), meta: { title: 'Experiments', icon: constants.EXPERIMENTS_ICON, drawerMenu: true, breadcrumbs: [{title: 'Experiments', disabled: true }] }},
  ...
  { path: '/experiments/receipt-bulk-upload', name: 'receipt-bulk-upload', component: () => import('./views/ProofReceiptAddMultiple.vue'), meta: { title: 'ReceiptBulkUpload', icon: 'mdi-image-plus', requiresAuth: true, breadcrumbs: [{title: 'Experiments', disabled: false, to: '/experiments' }, {title: 'ReceiptBulkUpload', disabled: true }] }},
  ...
  { path: '/moderation', name: 'moderation-dashboard', component: () => import('./views/ModerationDashboard.vue'), meta: { title: 'Moderation', icon: constants.MODERATION_ICON, drawerMenu: true, requiresModerator: true, breadcrumbs: [{title: 'Moderation', disabled: true }] }},
  { path: '/stats', name: 'stats', component: () => import('./views/Stats.vue'), meta: { title: 'Stats', icon: constants.STATS_ICON, drawerMenu: true, breadcrumbs: [{title: 'Stats', disabled: true }] }},
  { path: '/settings', name: 'settings', component: () => import('./views/Settings.vue'), meta: { title: 'Settings', icon: constants.SETTINGS_ICON, drawerMenu: true, breadcrumbs: [{title: 'Settings', disabled: true }] }},
  { path: '/about', name: 'about', component: () => import('./views/About.vue'), meta: { title: 'About', icon: constants.ABOUT_ICON, drawerMenu: true, breadcrumbs: [{title: 'About', disabled: true }] }},
