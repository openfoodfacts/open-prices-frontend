...
const routes = [
  ...
  { path: '/proofs/add/multiple', name: 'proof-add-multiple', component: () => import('./views/ProofPriceTagAddMultiple.vue'), meta: { title: 'AddProofSingleMultiple', icon: 'mdi-image-plus', requiresAuth: true, breadcrumbs: [{title: 'AddProofSingleMultiple', disabled: true }] }},
