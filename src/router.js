...
const routes = [
  ...
  { path: '/proofs/add/receipts', name: 'proof-add-multiple-receipts', component: () => import('./views/ProofReceiptAddMultiple.vue'), meta: { title: 'AddProofsReceipts', icon: 'mdi-image-plus', requiresAuth: true, breadcrumbs: [{ title: 'Proofs', disabled: false, to: '/proofs' }, { title: 'Add', disabled: true }, { title: 'Receipts', disabled: true }] }},
