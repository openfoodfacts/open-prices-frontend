...
const routes = [
  ...
  { path: '/contribute', name: 'contribute', component: () => import('./views/Contribute.vue'), meta: { title: 'Contribute', icon: 'mdi-hand-heart-outline', drawerMenu: true, breadcrumbs: [{title: 'Contribute', disabled: true }] }},
