...
const routes = [
  ...
  { path: '/experiments/proofs-open-for-contribution', name: 'proofs-open-for-contribution', component: () => import('./views/ProofsOpenForContribution.vue'), meta: { title: 'ProofsOpenForContribution', icon: 'mdi-image-search-outline', requiresAuth: true, breadcrumbs: [{title: 'Experiments', disabled: false, to: '/experiments' }, {title: 'ProofsOpenForContribution', disabled: true }] }},
