...
const routes = [
  ...
  { path: '/experiments/challenge', name: 'CommunityChallenge', component: () => import('./views/CurrentChallenge.vue'), meta: { title: 'Community Challenge', icon: 'mdi-medal-outline',  breadcrumbs: [{title: 'Experiments', disabled: false, to: '/experiments' }, {title: 'CommunityChallenge', disabled: true }] }},
  // Why this redirect?
