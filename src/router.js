...
const routes = [
  ...
  { path: '/users/:username', name: 'user-detail', component: () => import('./views/UserProofList.vue'), meta: { title: 'User detail', breadcrumbs: [{title: 'Users', disabled: false, to: '/users' }, {title: 'Username', disabled: false, to: '/users/:username' }, {title: 'Proofs', disabled: true }] }},
  { path: '/users/:username/proofs', name: 'user-proofs', component: () => import('./views/UserProofList.vue'), meta: { title: 'User proofs' }},
