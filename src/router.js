...
const routes = [
  ...
  { path: '/explore', name: 'explore', component: () => import('./views/Explore.vue'), meta: { title: 'Explore', icon: 'mdi-magnify', drawerMenu: true, breadcrumbs: [{title: 'Explore', disabled: true }] }},
