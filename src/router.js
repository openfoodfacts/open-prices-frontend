...
const routes = [
  ...
  { path: '/proofs', name: 'proofs', component: () => import('./views/ProofList.vue'), meta: { title: 'LatestProofs', icon: 'mdi-image-multiple', breadcrumbs: [{title: 'LatestProofs', disabled: true }] }},  // drawerMenu: true
