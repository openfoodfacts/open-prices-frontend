export default {
  ...
  OP_URL: 'https://prices.openfoodfacts.org',
  OP_BACKEND_GITHUB_URL: 'https://github.com/openfoodfacts/open-prices',
  OP_FRONTEND_GITHUB_URL: 'https://github.com/openfoodfacts/open-prices-frontend',
