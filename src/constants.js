export default {
  ...
  LANGUAGE_LIST: [
    ...
    { code: 'tr', value: 'TURKISH', name: 'Türkçe' },
    { code: 'he', value: 'HEBREW', name: 'עברית' },
    { code: 'uk', value: 'UKRAINIAN', name: 'Українська' },
    { code: 'ca', value: 'CATALAN', name: 'Català' },
    { code: 'ja', value: 'JAPANESE', name: '日本語' },
    { code: 'tr', value: 'TURKISH', name: 'Türkçe' },
    { code: 'tr', value: 'TURKISH', name: 'Türkçe' },
    { code: 'tr', value: 'TURKISH', name: 'Türkçe' },
    { code: 'tr', value: 'TURKISH', name: 'Türkçe' },
